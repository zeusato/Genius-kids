// ============================================================================
//  RNG có hạt giống (seeded) — để level TÁI LẬP được và test được.
//  Thay cho Math.random() rải rác (không tất định). Caller cấp seed (có thể
//  lấy từ Date.now() MỘT lần ở tầng UI — đó là code ứng dụng, được phép).
// ============================================================================
