    ...
    plugins: [
      ...
      VitePWA({
        ...
        workbox: {
          ...
          globIgnores: ['**/speed-math/art/**', '**/hub/art/**', '**/horse-race/art/concept.webp', '**/horse-race-preview.html', '**/speed-preview.html', '**/hub-preview.html', '**/racing-preview.html', '**/gears-preview.html'],
          runtimeCaching: [
            {
