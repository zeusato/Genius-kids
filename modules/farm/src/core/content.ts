...
export const ASSETS = { ...OLD_ASSETS, ...Object.fromEntries(buildingRows.map(([id, name, level, price, width, depth, description]) => [id, { name, level, price, width, depth, description, kind: 'building', color: '#a88860' }])), path: { name: 'Lối đi', description: 'Tự đẹp lên theo các mốc ngoại hình của Nhà chính.', width: 1, depth: 1, price: 5, level: 1, kind: 'decor', color: '#b9b295' }, statue: { name: 'Cột mùa gặt', description: 'Dấu mốc nông trại trưởng thành.', width: 2, depth: 2, price: 1500, level: 21, kind: 'decor', color: '#b7b09c' } } as Record<AssetId, AssetSpec>;
